...
// NOVOS LINKS DO DISTRITO PETROLÂNDIA
// ===================================
const SHEET_ID = '1KlAp03X0t-IxH1fmWnsG9IZIQOZa3IQOt_6l3peubmc';

const SHEETS = [
  {
    name: 'PENDÊNCIAS PETROLÂNDIA',
    url: gvizCsvUrl(SHEET_ID, '568154847'),
    distrito: 'PETROLÂNDIA',
    tipo: 'PENDENTE'
  },
  {
    name: 'RESOLVIDOS PETROLÂNDIA',
    url: gvizCsvUrl(SHEET_ID, '1968686065'),
    distrito: 'PETROLÂNDIA',
    tipo: 'RESOLVIDO'
  }
];
...
function downloadExcel() {
  ...
  XLSX.writeFile(wb, `Dados_Petrolandia_${hoje}.xlsx`);
}
